...
from src.trellis import trellis_in_src as tl
...
例）　100
> """)
            canvas_width_obj = tl.InningsPitched(var_value=canvas_width_var_value)
...
例）　100
> """)
            canvas_height_obj = tl.InningsPitched(var_value=canvas_height_var_value)
